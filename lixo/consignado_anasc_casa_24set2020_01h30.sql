...
--
-- Host: 127.0.0.1
-- Generation Time: 24-Set-2020 às 06:29
...
(77, 1, 6, 'fatura (1).pdf', 'uploads/1/', '2020-01-01 00:00:00'),
(78, 1, 6, 'fatura (1).pdf', 'uploads/1/', '2020-01-01 00:00:00');
...
INSERT INTO `tab_tipo_arquivo_anexo` (`id_tipo_arquivo`, `extensao_tipo_arquivo`, `icone_anexo`, `autorizado`) VALUES
(1, 'doc', '<i class=\"far fa-file-word\"></i>', 1),
(2, 'docx', '<i class=\"far fa-file-word\"></i>', 1),
(3, 'gif', '<i class=\"far fa-file-image\"></i>', 1),
(4, 'jpg', '<i class=\"far fa-file-image\"></i>', 1),
(5, 'jpeg', '<i class=\"far fa-file-image\"></i>', 1),
(6, 'pdf', '<i class=\"far fa-file-pdf\"></i>', 1),
(7, 'png', '<i class=\"far fa-file-image\"></i>', 1),
(8, 'txt', '<i class=\"far fa-file-alt\"></i>', 1);
...
--
ALTER TABLE `tab_anexos`
  MODIFY `id_anexo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
